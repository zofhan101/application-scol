...
@section('title', 'Transfert - autres inscriptions')
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card">
              <div class="card-body">
                <!-- Vertical Form -->
                <form class="row g-3" action="{{ route('autres_inscriptions_transfert') }}" method="POST" >
                    @csrf
                  ...
                  <div class="text-center">
                    <button type="submit" class="w-100 btn btn-primary">Finaliser l'inscription</button>
                  </div>
                </form><!-- Vertical Form -->
