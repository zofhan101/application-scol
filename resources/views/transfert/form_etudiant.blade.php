...
@section('title', 'Transfert- infos étudiant')
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card">
              <div class="card-body">
                <!-- Vertical Form -->
                <form class="row g-3" action="{{ route('form_etudiant_transfert') }}" method="POST" >
                    @csrf
                  ...
                  <div class="col-12">
                    <label for="inputAddress" class="form-label">Nom</label>
                        ...
                        @enderror
                    <input type="text" class="form-control" id="inputAddress" name="nom" value="{{ old('nom') }}">
                  </div>
                  ...
                  <div class="col-12">
                    <label for="inputAddress" class="form-label">Prénoms</label>
                        ...
                        @enderror
                    <input type="text" class="form-control" id="inputAddress" name="prenoms" value="{{ old('prenoms') }}">
                  </div>
