...
@section('title', 'Transfert - identité de l\'étudiant')
                ...
                <form class="row g-3" action="{{ route('form_identite_transfert') }}" method="POST" >
                        ...
                        <label for="inputAddress" class="form-label">Nationalite</label>
                            ...
                            <select class="form-select" aria-label="Default select example" name="nationalite">
                                @foreach($nationalites as $nationalite)
                                    <option value="{{ $nationalite->id_nationalites }}" @if(old('nationalite') == $nationalite->id_nationalites) selected @endif>{{ $nationalite->nom_nationalite }}</option>
                                @endforeach
                            </select>
                  ...
                  <div class="col-12">
                    ...
                    <select name="type_pi" id="">
                        ...
                        <option value="cin"@if(old('type_pi') =='cin') selected @endif>CIN</option>
                        <option value="pass" @if(old('type_pi') =='pass') selected @endif>Passeport</option>
