...
@section('content')
<div class="pagetitle">
    <h1>Choix de la mention (ou parcours) et le niveau à délibérer</h1>
</div>
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card">
              <div class="card-body">
                <!-- Vertical Form -->
                <form class="row g-3"  id="form" action="{{ route('notes.interface_deliberation') }}" method="POST">
                    @csrf
                  ...
                  <div class="text-center d-flex">
                    <button type="submit" class="btn btn-primary w-100"> Accéder à l'interface de délibération</button>
                  </div>
                </form>
