...
<div class="pagetitle" id = "pagetitle2">
    <h1>Statistiques sur la saisie</h1>
...
<section class="section">
    <div class="row">
        ...
        <div class="col-lg-4 col-md-4">
            <div class="card info-card sales-card">
                <div class="card-body">
                    <h5 class="card-title">Nombre de notes enregistrées</h5>
        ...
        <div class="col-lg-4 col-md-4">
            <div class="card info-card sales-card">
                <div class="card-body">
                    <h5 class="card-title">Copies restantes</h5>
...
<script>
    ...
    ecs_el.addEventListener('change', get_stats_saisie_note);

    async function get_stats_saisie_note(){
        //récupération des ec correspondants aux niveau et parcours et ue sélectionnés
        let url = "{{route('get_stats_saisie_note')}}";
    ...
    // SCAN DES CODE-BARRES ET SAISIE DES NOTES
