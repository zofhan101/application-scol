...
<div class="pagetitle" id = "pagetitle2">
    <h1>Statistiques sur la vérification des notes</h1>
...
<section class="section">
    <div class="row">
        ...
        <div class="col-lg-4 col-md-4">
            <div class="card info-card sales-card">
                <div class="card-body">
                    <h5 class="card-title">Nombre de notes vérifiées</h5>
        ...
        <div class="col-lg-4 col-md-4">
            <div class="card info-card sales-card">
                <div class="card-body">
                    <h5 class="card-title">Notes encore à vérifier</h5>
...
<script>
    ...
    async function get_stats_verification_note(){
        ...
        let url = "{{route('get_stats_verification_note')}}";
    ...
    //SCAN DES CODE BARRES ET VERIFICATION DES EN-NOTES
