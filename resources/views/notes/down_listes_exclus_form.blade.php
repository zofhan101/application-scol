...
@section('content')
<div class="pagetitle">
    <h1>Téléchargement des listes des exclus</h1>
</div>
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card">
              <div class="card-body">
                <!-- Vertical Form -->
                <form class="row g-3" action="{{ route('notes.get_listes_exclus') }}" method="POST" id="form">
                    @csrf
                  ...
                  <div class="text-center d-flex">
                    <button type="submit" class="w-100 btn btn-primary" id="all">Télécharger la liste des exclus</button>
