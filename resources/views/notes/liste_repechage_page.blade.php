...
@section('title', 'Liste de repeêchage')

@section('content')
<div class="pagetitle">
    <h1>Consultation de la liste de repêchage</h1>
</div>
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card">
              <div class="card-body">
                <!-- Vertical Form -->
                <form class="row g-3" action="{{ route('notes.get_liste_repechage') }}" method="POST" >
                    @csrf
                  ...
                  <div class="text-center">
                    <button type="submit" class="w-100 btn btn-primary">Consulter la liste</button>
                  </div>
                </form><!-- Vertical Form -->
