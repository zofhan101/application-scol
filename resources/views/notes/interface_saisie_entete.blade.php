...
<div class="pagetitle" id = "pagetitle2">
    <h1>Statistiques sur la saisie des en-têtes</h1>
...
<section class="section">
    <div class="row">
        ...
        <div class="col-lg-4 col-md-4">
            <div class="card info-card sales-card">
                <div class="card-body">
                    <h5 class="card-title">Nombre d'en-têtes enregistrées</h5>
        ...
        <div class="col-lg-4 col-md-4">
            <div class="card info-card sales-card">
                <div class="card-body">
                    <h5 class="card-title">En-têtes restantes</h5>
...
<script>
    ...
    // SCAN DES CODE BARRE ET INSERTION DES EN TETES
