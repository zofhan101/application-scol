    ...
    <section class="section">
        ...
        <div class="row" id="contenu"  >
            ...
            <div class ="row">
                ...
                <div class="col-contenu">: {{  $inscription->pere }}</div>
            </div>

            <div class ="row">
                <div class="col-titre"><b>et de</b></div>
                <div class="col-contenu">: {{ $inscription->mere }}</div>
            </div>
            ...
            <div class ="row">
                ...
                <div class="col-contenu">: {{ $formatted_date_naissance }}    <b> &nbsp;&nbsp;&nbsp;&nbsp; à &nbsp;&nbsp;&nbsp;&nbsp;</b> {{ $inscription->lieu_naissance }} </div>
            </div>
            <div class="row">
                    est régulièrement inscrit(e) en &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>{{ $inscription->nom_niveau }} </b> <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span> -  <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                    <b>Matricule: </b> {{ $inscription->im }}
            </div>

            <div class="row">
                <div class="col-titre"><b>Mention</b></div>
                <div class="col-contenu">
                    : <b>{{ $inscription->nom_mention }}</b>
                    <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                    @if($inscription->nom_mention !== $inscription->nom_parcours)
                        <b>Parcours: </b>
                        <b>{{  $inscription->nom_parcours }}</b>
                    @endif
                </div>
            </div>
