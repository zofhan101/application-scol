...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::table('etudiants', function (Blueprint $table) {
            $table->dropColumn('niveau_au_transfert');
            $table->BigInteger('id_niveau_transfert')->nullable();
            $table->foreign('id_niveau_transfert')->references('id_niveau')->on('niveau');
        });
    ...
    public function down(): void
    {
        ...
        Schema::table('etudiants', function (Blueprint $table) {
            $table->dropColumn('id_au_transfert');
        });
    }
};
