...
class ListeTriplantsExport implements WithEvents, WithTitle,FromCollection, WithCustomStartCell, WithHeadings, WithDrawings
{
    protected $data;
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $sheet->setCellValue('C12', "Liste des étudiants autorisés à tripler");
