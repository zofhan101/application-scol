...
class ListeRepechageExport implements FromCollection, WithDrawings, WithHeadings, WithEvents, WithMapping, WithCustomStartCell, WithStyles, WithTitle
{
    protected $data;
     ...
     * @param int $startRow
     */
    public function __construct($data, $subtitles, $legendes, $startRow = 11)
    {
        $this->data = $data;
